...
sprite("Project:Face"..math.floor((face1).x), WIDTH/4, HEIGHT/4, WIDTH/14)
sprite("Project:Nose"..math.floor((face1).y), WIDTH/4, HEIGHT/4, WIDTH/28)
sprite("Project:eyes"..math.floor((face1).z), WIDTH/4, HEIGHT/4, WIDTH/20)
sprite("Project:Face"..math.floor((face2).x), WIDTH/2, HEIGHT/4, WIDTH/14)
sprite("Project:Nose"..math.floor((face2).y), WIDTH/2, HEIGHT/4, WIDTH/28)
sprite("Project:eyes"..math.floor((face2).z), WIDTH/2, HEIGHT/4, WIDTH/20)
sprite("Project:Face"..math.floor((face3).x), 3*WIDTH/4, HEIGHT/4, WIDTH/14)
sprite("Project:Nose"..math.floor((face3).y), 3*WIDTH/4,HEIGHT/4, WIDTH/28)
sprite("Project:eyes"..math.floor((face3).z), 3*WIDTH/4, HEIGHT/4, WIDTH/20)
